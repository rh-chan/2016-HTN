...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactSpinner = __webpack_require__(161);

	var _reactSpinner2 = _interopRequireDefault(_reactSpinner);

	var _reactSearchInput = __webpack_require__(162);
	...
	var Search = _react2.default.createClass({
	  ...
	  render: function render() {
	    ...
	    return _react2.default.createElement(
	      'div',
	      null,
	      _react2.default.createElement(_reactSearchInput2.default, { className: 'search-input', onChange: this.searchUpdated, onFocus: this.onFocus }),
	      this.state.focus ? _react2.default.createElement(
	        'div',
	        { className: 'optionList' },
	        this.state.searchResults.map(function (restaurant) {
	          return _react2.default.createElement(
	            'div',
	            { className: 'restaurant', 'data-id': restaurant.id, key: restaurant.id, onClick: _underscore2.default.bind(_this.selectRestaurant, _this) },
	      ...
	      _react2.default.createElement(
	        'div',
	        { className: 'container selectedContainer' },
	        _react2.default.createElement(
	          'div',
	          { className: 'row' },
	          _react2.default.createElement(
	            'div',
	            { className: 'selected chosenList col-xs-10 col-xs-offset-1' },
	            _react2.default.createElement(
	              'div',
	              { className: 'columnTitle' },
	              'C H O I C E S'
	            ),
	            this.state.selectedRestaurants.map(function (restaurant) {
	              return _react2.default.createElement(
	                'div',
	                { className: 'chosenRestaurant', 'data-id': restaurant.id, key: restaurant.id },
	                _react2.default.createElement(
	                  'div',
	                  { className: 'right', 'data-id': restaurant.id, onClick: _underscore2.default.bind(_this.deleteRestaurant, _this) },
	  ...
	  searchUpdated: function searchUpdated(term) {
	    $.get("/yelp_search", { name: term, location: "waterloo" }, _underscore2.default.bind(function (data) {
	  ...
	  selectRestaurant: function selectRestaurant(selectedRestaurant) {
	    ...
	    currentRestaurants.push(_underscore2.default.find(this.state.searchResults, function (restaurant) {
	      return restaurant.id === selectedRestaurant.data("id");
	    }));
	    this.setState({ selectedRestaurants: currentRestaurants, focus: false });
	  },
	  deleteRestaurant: function deleteRestaurant(deletedRestaurant) {
	    ...
	    selectedRestaurants = _underscore2.default.reject(selectedRestaurants, function (r) {
	      return r.id == id;
	    });
	    deletedRestaurant.parent().fadeOut(400, _underscore2.default.bind(function () {
	...
	var App = _react2.default.createClass({
	  ...
	  render: function render() {
	    if (this.state.step === 'name') {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement('input', { id: 'nameInput', type: 'text' }),
	            _react2.default.createElement(
	              'button',
	              { type: 'button', className: 'btn btn-primary', onClick: this.handleName },
	              'start'
	            )
	          )
	        )
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'button',
	          { type: 'button', className: 'btn btn-primary', onClick: this.handleCreated },
	          'create choosr poll'
	        ),
	        _react2.default.createElement(
	          'button',
	          { type: 'button', className: 'btn btn-info', onClick: this.gotoCreated },
	          'join existing choosr'
	        )
	      );
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement('input', { id: 'roomInput', type: 'text' }),
	            _react2.default.createElement(
	              'button',
	              { type: 'button', className: 'btn btn-primary join-btn', onClick: this.handleJoin },
	              'join'
	            )
	          )
	        )
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(Search, { ref: 'search' }),
	        _react2.default.createElement(
	          'div',
	          { className: 'center' },
	          _react2.default.createElement(
	            'button',
	            { type: 'button', className: 'btn btn-success', onClick: this.doneSubmitting },
	            'finish'
	          )
	        )
	      );
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          ' Friends that have submitted their suggestions: '
	        ),
	        _react2.default.createElement(
	          'div',
	          { className: 'container selectedContainer submittedContainer' },
	          _react2.default.createElement(
	            'div',
	            { className: 'row' },
	            _react2.default.createElement(
	              'div',
	              { className: 'selected votedPerson col-xs-10 col-xs-offset-1' },
	              _underscore2.default.map(this.state.doneSubmitting, function (person) {
	                return _react2.default.createElement(
	                  'div',
	                  { className: 'submittedPerson', 'data-id': person, key: person },
	                  _react2.default.createElement(
	                    'p',
	                    { className: 'name' },
	                    person
	        ...
	        _react2.default.createElement(
	          'button',
	          { type: 'button', className: 'btn btn-success', onClick: this.startVoting },
	          'start voting'
	        )
	      );
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'div',
	          { className: 'selected votedRestaurant' },
	          _react2.default.createElement(
	            'div',
	            { className: 'submittedPerson', 'data-id': restaurant.suggestion, key: restaurant.suggestion_name },
	            _react2.default.createElement(
	              'p',
	              { className: 'name' },
	              restaurant.suggestion_name
	            ),
	            _react2.default.createElement(
	              'p',
	              { className: 'location' },
	            ...
	            _react2.default.createElement(
	              'button',
	              { type: 'button', className: 'btn btn-success', 'data-id': restaurant.suggestion, 'data-rank': '2', onClick: this.vote },
	              'so down'
	            ),
	            _react2.default.createElement(
	              'button',
	              { type: 'button', className: 'btn btn-info', 'data-id': restaurant.suggestion, 'data-rank': '1', onClick: this.vote },
	              'meh'
	            ),
	            _react2.default.createElement(
	              'button',
	              { type: 'button', className: 'btn btn-warning', 'data-id': restaurant.suggestion, 'data-rank': '0', onClick: this.vote },
	              'nah'
	            )
	          )
	        )
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'p',
	          { className: 'center title' },
	          ' You\'re done voting! Now we\'re waiting for your friends to submit their votes. '
	        ),
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            'p',
	            null,
	            this.state.winner.suggestion_name,
	            ' '
	          ),
	          _react2.default.createElement(
	            'p',
	  ...
	  vote: function vote(e) {
	    $.post("/suggestion_vote", { rank: $(e.target).data("rank"), suggestion: $(e.target).data("id"), user_id: this.state.userId }, _underscore2.default.bind(function (data) {
	      ...
	      if (newIndex >= this.state.restaurants.length) {
	        ...
	        interval3 = setInterval(_underscore2.default.bind(this.checkVotingEnd, this), 1000);
	      } else {
	        this.setState({ votedIndex: newIndex });
	      }
	    }, this));
	  },
	  checkVotingEnd: function checkVotingEnd(e) {
	    $.get("/check_room_votes", { room_id: this.state.roomId }, _underscore2.default.bind(function (data) {
	      if (JSON.parse(data) == true) {
	        clearInterval(interval3);
	        $.get("/rank_algo", { room_id: this.state.roomId }, _underscore2.default.bind(function (data) {
	          var winner = JSON.parse(data)[0][0];
	          winner = _underscore2.default.find(this.state.restaurants, _underscore2.default.bind(function (restaurant) {
	  ...
	  startVoting: function startVoting() {
	    $.get("/update_room_status", { room_id: this.state.roomId }, _underscore2.default.bind(function (data) {
	  ...
	  handleName: function handleName(form) {
	    this.setState({ step: "create", name: $("#nameInput").val() });
	  },
	  gotoCreated: function gotoCreated() {
	    this.setState({ step: 'join' });
	  },
	  handleJoin: function handleJoin() {
	    $.post("/user", { name: this.state.name, room_id: $("#roomInput").val() }, _underscore2.default.bind(function (data) {
	  ...
	  handleCreated: function handleCreated() {
	    $.post("/room", { name: this.state.name, room_name: "paninos" }, _underscore2.default.bind(function (data) {
	  ...
	  doneSubmitting: function doneSubmitting() {
	    $.post("/suggestions", { suggestions: JSON.stringify(this.refs.search.state.selectedRestaurants), room_id: this.state.roomId, user_id: this.state.userId }, _underscore2.default.bind(function (data) {
	      this.setState({ step: "waiting" });
	    }, this));
	    interval1 = setInterval(_underscore2.default.bind(this.checkWhosDone, this), 1000);
	    interval2 = setInterval(_underscore2.default.bind(this.checkIfStartVote, this), 1000);
	  },
	  checkWhosDone: function checkWhosDone() {
	    $.get("/room_submitted", { room_id: this.state.roomId }, _underscore2.default.bind(function (data) {
	      this.setState({ doneSubmitting: JSON.parse(data) });
	    }, this));
	  },
	  checkIfStartVote: function checkIfStartVote() {
	    $.get("/room", { room_id: this.state.roomId }, _underscore2.default.bind(function (data) {
	  ...
	  getAllSuggestions: function getAllSuggestions() {
	    $.get("/suggestions", { room_id: this.state.roomId }, _underscore2.default.bind(function (data) {
	...
	var Dropdown = _react2.default.createClass({
	  ...
	  render: function render() {
	    return _react2.default.createElement('div', { className: 'center' });
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _fuse = __webpack_require__(164);
